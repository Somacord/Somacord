...
## Notes
- Official Somacord Events and Partner Events don't have distinct pages/routes yet — everything under `/gatherings` is undifferentiated today, even though Official Somacord Events are now a launch-priority revenue stream (see [/docs/business/business-model.md](../business/business-model.md#revenue-priority)), not future work. This falls out of the same gap as the rest of the marketplace model — see [/docs/engineering/marketplace-implementation-plan.md](../engineering/marketplace-implementation-plan.md).
